  ...
  constructor(props) {
    ...
    this.state = {
      ...
      heading: this.props.data.title
        ...
        : 'Software Developer in Bay Area',
      address: this.props.data.address,
      applicantFname: '',
      applicantLname: '',
      profile_img: '',
            ...
            <div className="row ">
              ...
              <div className="col-md-6">
                <div id="cb" className="card-block">
                  <h3 id="card-heading-saved" className="card-title">
                    <Link id="jobsavedheading" to="">
                      {this.state.heading}
                    </Link>
                  </h3>
                  <div className="row">
              ...
              <div className="modal-body">
                <div className="row left-job-detail">
                  <div className="col-md-3 left-job-detail-image">
                    <img
                      src=""
                      className="img-fluid job-card-image-easy-apply"
                      alt=""
                    />
                  </div>
                  <div className="col-md-8 left-job-detail-desc">
                    <div>
                      <label className="heading-company">
                        {this.state.applicantFname} {this.state.applicantLname}
                      </label>
                    </div>
                    <div>
