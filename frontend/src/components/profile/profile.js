...
class profile extends Component {
  ...
  async componentDidMount() {
    if (sessionStorage.getItem("user_id")) {
      try {
        let recommendation = initData.recommendation
      ...
      for (var u = 0; u < this.state.skills.length; u++) {
        ...
        $("#skillstable").append(
          "<tr data-dellength=" +
            ...
            " ><td>" +
            this.state.skills[u] +
            '</td><td><i className="fa fa-trash custom-edit-buttons" onclick=delrows(' +
            currentLength +
            ") ></i></td></tr>"
        );
      }
        ...
        <div>
          <div className="row">
            <div className="col-md-3">
              <img src={S3_URL+jobs.company_logo} className="img-fluid job-card-image" alt="" />
            </div>
                        ...
                        <div className="col-lg-12 no-padding">
                          <div className="main-left-sidebar">
                            <div className="user_profile custom-wrapper">
                              ...
                              <div className="user_pro_status">
                                ...
                                {this.state.resume && (
                                  ...
                                  >
                                    <i className="fa fa-file-pdf resume-icon" />{" "}
                                    View Resume
                                  </div>
                                )}
                              </div>
                                  ...
                                  return (
                                    <div className="">
                                      <div className="suggestion-usd detail-boxes ">
                                        <span className="fa fa-briefcase left-icons" />
                              ...
                              <div className="suggestions-list">
                                {this.state.education.map((a, ind1) => {
                                  return (
                                    <div className="">
                                      <div className="suggestion-usd detail-boxes ">
                                        <span className="fa fa-certificate left-icons" />
                                        <div className="sgt-text">
                                          <h4>
                                            <div className="exp-title">
                                              {a.school}
                            ...
                            <div className=" custom-wrapper suggestions full-width">
                              ...
                              <div className="suggestions-list">
                                <div className="suggestion-usd detail-boxes ">
                                  <span className="fa fa-user-circle left-icons" />
                                  <div className="sgt-text">
                                    <div className="exp-company">
